                    ...
                    <div class="card col-sm-12 p-0 mb-2">
                        <div class="card-header align-items-center">
                            ...
                            <div class="float-right" >
                                <button type="button" id="btn-add" class="btn btn-primary btn-sm" style="font-size:30px; padding: 0px 15px">+</button>
                                <button type="button" id="btn-remove" class="btn btn-danger btn-sm" style="font-size:30px; padding: 0px 15px">-</button>
                            </div>
                ...
                <ul class="list-group row">
                    ...
                    <li class="list-group-item">
                        ...
                        <div class="img-thumbnail  text-center">
                            <img src="@if(isset($product)) {{asset('storage/'.$product->thumbnail)}} @else @endif" id="imgthumbnail" class="img-fluid" alt="">
                        </div>
                    </li>
                    <li class="list-group-item">
                        <div class="col-12">
